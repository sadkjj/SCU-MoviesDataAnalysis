...
const fetchYearlyProduction = async () => {
  try {
    ...
    const { data } = await axios.get<YearlyProductionData>(
      'http://127.0.0.1:4523/m1/6680275-6389502-default/api/basic/production/yearly',
      { params }
    )
...
const fetchMonthlyProduction = async () => {
  try {
    ...
    const params: any = {
      start_year: selectedMonthYear.value,
    }
    ...
    const { data } = await axios.get<MonthlyProductionData>(
      'http://127.0.0.1:4523/m1/6680275-6389502-default/api/basic/production/monthly',
      { params }
    )
...
const fetchCountryProduction = async () => {
  try {
    ...
    const { data } = await axios.get<CountryProductionData>(
      'http://127.0.0.1:4523/m1/6680275-6389502-default/api/basic/production/countries',
      { params }
    )
