...
const fetchUsers = async () => {
  ...
  try {
    const res = await axios.get('http://127.0.0.1:4523/m1/6680275-6389502-default/api/admin/users', { params })
    if (res.data.success) {
...
const submitCreate = async () => {
  try {
    const res = await axios.post(
      'http://127.0.0.1:4523/m1/6680275-6389502-default/api/admin/user',
      createForm
    )
...
const submitEdit = async () => {
  try {
    const res = await axios.put(
      `http://127.0.0.1:4523/m1/6680275-6389502-default/api/user/${editForm.user_id}`,
      editForm
    )
    if (res.data.success) {
      fetchUsers()
...
const deleteUser = async (id) => {
  ...
  try {
    const res = await axios.delete(
      `http://127.0.0.1:4523/m1/6680275-6389502-default/api/user/${id}`
    )
    if (res.data.success) {
      fetchUsers()
    }
